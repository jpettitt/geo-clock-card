  ...
  `}setConfig(e){if(!e)throw new Error("geo-clock-card: missing config");const t=function(e){if("string"!=typeof e||0===e.length)return;try{const t=new URL(e,import.meta.url),i="undefined"!=typeof location?location.protocol:"https:";return"https:"===t.protocol||"http:"===t.protocol||t.protocol===i?e:void 0}catch{return}}(e.imageryBase)??new URL(".",import.meta.url).href,i=function(e){if(null==e)return;const t=e instanceof Date?e:new Date(e);return Number.isFinite(t.getTime())?t:void 0}(e.now);this.config={twilightDegrees:Ve(e.twilightDegrees??8,1,18),updateInterval:Ve(e.updateInterval??1,1,600),showUTC:e.showUTC??!0,showTimezoneBand:e.showTimezoneBand??!0,showTimezoneBoundaries:e.showTimezoneBoundaries??!0,showTimezoneRegions:e.showTimezoneRegions??e.showTimezoneBoundaries??!0,showTimezonePopup:e.showTimezonePopup??!0,timezoneLineColor:We(e.timezoneLineColor)??"rgba(255, 255, 255, 0.18)",dayBrightness:Ve(e.dayBrightness??1.15,0,5),nightContrast:Ve(e.nightContrast??1,0,5),twilightColor:We(e.twilightColor)??"#463701",twilightOpacity:Ve(e.twilightOpacity??.26,0,1),imageryBase:t.endsWith("/")?t:t+"/",center:e.center??"sun",centerLongitude:"number"==typeof e.centerLongitude?Ve(e.centerLongitude,-180,180):void 0,centerEntity:e.centerEntity,showHomeMarker:e.showHomeMarker??!1,showHomeMarkerLabel:e.showHomeMarkerLabel??!1,markers:Ge(e.markers),markerLabelMode:"hover"===e.markerLabelMode?"hover":"always",markerColor:We(e.markerColor),markerDayColor:We(e.markerDayColor),markerNightColor:We(e.markerNightColor),markerShowDay:e.markerShowDay??!0,mainTimeSource:qe(e.mainTimeSource),mainTimeEntity:e.mainTimeEntity,frozenNow:i};const o=i??new Date;this.displayNow=o,this.mapNow=o,this.ianaTzCache.clear(),this.tzPolygons=null,this.tzIanaPolygons=null,this.tzPolygonsCenterLon=null,this.restartTimer(),this.maybeLoadTimezones(),this.maybeLoadIanaTimezones()}connectedCallback(){if(super.connectedCallback(),!this.config?.frozenNow){const e=new Date;this.displayNow=e,this.mapNow=e}this.attachVisibilityObservers(),this.restartTimer(),this.maybeLoadTimezones(),this.maybeLoadIanaTimezones()}disconnectedCallback(){super.disconnectedCallback(),this.stopTimer(),this.clearDismissTimer(),this.clearIdleTimer(),this.detachVisibilityObservers(),this.hoverPosRaf&&(cancelAnimationFrame(this.hoverPosRaf),this.hoverPosRaf=0)}attachVisibilityObservers(){"undefined"==typeof IntersectionObserver||this.intersectionObserver||(this.intersectionObserver=new IntersectionObserver(e=>{const t=e[e.length-1];this.intersecting=!t||t.isIntersecting,this.recomputeVisibility()},{threshold:0}),this.intersectionObserver.observe(this)),"undefined"==typeof document||this.onTabVisibility||(this.onTabVisibility=()=>this.recomputeVisibility(),document.addEventListener("visibilitychange",this.onTabVisibility))}detachVisibilityObservers(){this.intersectionObserver?.disconnect(),this.intersectionObserver=void 0,this.onTabVisibility&&"undefined"!=typeof document&&document.removeEventListener("visibilitychange",this.onTabVisibility),this.onTabVisibility=void 0}recomputeVisibility(){const e="undefined"==typeof document||"hidden"!==document.visibilityState,t=this.intersecting&&e;if(t!==this.isCardVisible){if(this.isCardVisible=t,t){const e=new Date;this.displayNow=e,this.mapNow=e}this.restartTimer()}}restartTimer(){if(this.stopTimer(),!this.config||!this.isConnected)return;if(this.config.frozenNow)return;const e=this.isCardVisible?1e3*this.config.updateInterval:18e5;this.timer=setInterval(()=>this.tick(),e)}tick(){const e=new Date;this.displayNow=e,e.getTime()-this.mapNow.getTime()>=10546.875&&(this.mapNow=e)}stopTimer(){void 0!==this.timer&&(clearInterval(this.timer),this.timer=void 0)}maybeLoadTimezones(){if(!this.config?.showTimezoneRegions||null!==this.tzData)return;(function(e){return Oe&&Ne===e||(Ne=e,Oe=fetch(e).then(e=>{if(!e.ok)throw new Error(`tz fetch failed: ${e.status}`);return e.json()})),Oe})(this.config.imageryBase+"timezones.json").then(e=>{this.tzData=e,this.requestUpdate()}).catch(e=>{console.warn("geo-clock-card: timezone overlay failed to load:",e)})}maybeLoadIanaTimezones(){if(!this.config||null!==this.tzIanaData)return;const e=this.config.markers.length>0,t="entity"===this.config.mainTimeSource,i="home"===this.config.mainTimeSource&&"string"!=typeof this.hass?.config?.time_zone;if(!(this.config.showTimezoneBoundaries||e||t||i))return;(function(e){return Me&&Se===e||(Se=e,Me=fetch(e).then(e=>{if(!e.ok)throw new Error(`iana tz fetch failed: ${e.status}`);return e.json()})),Me})(this.config.imageryBase+"timezones-iana.json").then(e=>{this.tzIanaData=e,this.ianaTzCache.clear(),this.requestUpdate()}).catch(e=>{console.warn("geo-clock-card: IANA timezone overlay failed to load:",e)})}static{this.FALLBACK_CENTER_LON=0}resolveCenterLon(e){if(!this.config)return $e(e).lon;switch(this.config.center){case"home":{const e=this.hass?.config?.longitude;return"number"==typeof e?e:(this.warnFallback("home","hass.config.longitude is not set; falling back to Greenwich (0°)"),Re.FALLBACK_CENTER_LON)}case"longitude":return"number"==typeof this.config.centerLongitude?this.config.centerLongitude:(this.warnFallback("longitude","centerLongitude not set; falling back to Greenwich (0°)"),Re.FALLBACK_CENTER_LON);case"entity":{const e=this.config.centerEntity,t=e?this.hass?.states?.[e]:void 0,i=t?.attributes?.longitude;return"number"==typeof i?i:(this.warnFallback("entity",e?`entity '${e}' has no numeric longitude attribute; falling back to Greenwich (0°)`:"centerEntity not set; falling back to Greenwich (0°)"),Re.FALLBACK_CENTER_LON)}default:return $e(e).lon}}warnFallback(e,t){const i=`${e}|${t}`;this.warnedFallback!==i&&(this.warnedFallback=i,console.warn(`geo-clock-card: center mode '${e}' — ${t}`))}resolveHomeLatLon(){const e=this.hass?.config?.latitude,t=this.hass?.config?.longitude;return"number"!=typeof e||"number"!=typeof t?null:{lat:e,lon:t}}lookupIanaTz(e,t){if(!this.tzIanaData)return null;const i=`${e.toFixed(2)},${t.toFixed(2)}`;let o=this.ianaTzCache.get(i);return void 0===o&&(o=function(e,t,i){if("number"!=typeof t||"number"!=typeof i||!Number.isFinite(t)||!Number.isFinite(i))return null;const o=((i+180)%360+360)%360-180;for(const i of e.features){const e="Polygon"===i.geometry.type?[i.geometry.coordinates]:i.geometry.coordinates;for(const r of e)if(0!==r.length&&Pe(r[0],o,t))return i.properties.tzid}return null}(this.tzIanaData,e,t),this.ianaTzCache.size>=512&&this.ianaTzCache.clear(),this.ianaTzCache.set(i,o)),o}resolveMainTimezone(){if(this.config)switch(this.config.mainTimeSource){case"device":return;case"home":{const e=this.hass?.config?.time_zone;if("string"==typeof e&&e)return e;const t=this.resolveHomeLatLon();return t&&this.tzIanaData?this.lookupIanaTz(t.lat,t.lon)??void 0:void 0}case"entity":{const e=this.config.mainTimeEntity,t=e?this.hass?.states?.[e]:void 0,i=t?.attributes?.latitude,o=t?.attributes?.longitude;return"number"==typeof i&&"number"==typeof o&&this.tzIanaData?this.lookupIanaTz(i,o)??void 0:void 0}}}resolveMarkers(){if(!this.config||0===this.config.markers.length)return[];const e=[];for(const t of this.config.markers){const i=this.hass?.states?.[t.entity];if(!i)continue;const o=i.attributes?.latitude,r=i.attributes?.longitude;if("number"!=typeof o||"number"!=typeof r)continue;const s="string"==typeof i.attributes?.friendly_name?i.attributes.friendly_name:t.entity,n="string"==typeof t.label&&t.label.trim()||s,a=this.lookupIanaTz(o,r);e.push({entity:t.entity,label:n,color:We(t.color)??this.config.markerColor,dayColor:We(t.dayColor)??this.config.markerDayColor,nightColor:We(t.nightColor)??this.config.markerNightColor,lat:o,lon:r,tzid:a})}return e}terminatorGeometry(e,t){const i=e.getTime(),o=this.terminatorCache;if(o&&o.mapNowMs===i&&o.centerLon===t)return o;const r=$e(e),s=function(e,t={}){const i=t.stepDeg??1,o=(t.centerLon??180)-180;let r=e.lat;Math.abs(r)<_e&&(r=r>=0?_e:-1e-4);const s=Math.tan(r*ke),n=[];for(let t=0;t<=360;t+=i){const i=(o+t-e.lon)*ke,r=Math.atan(-Math.cos(i)/s)*xe;n.push([t,r])}return n}(r,{centerLon:t}),n=r.lat>=0?-90:90,a=s.slice(0,-1),l=[...a.map(([e,t])=>[e-360,t]),...a,...s.map(([e,t])=>[e+360,t])],h={mapNowMs:i,centerLon:t,points:Te([...a.slice(a.length-45).map(([e,t])=>[e-360,t]),...a.map(([e,t])=>[e,t]),...s.slice(0,46).map(([e,t])=>[e+360,t]),[405,n],[-45,n]],Be,Fe),curvePoints:Te(l,Be,Fe)};return this.terminatorCache=h,h}render(){if(!this.config)return V``;const e=this.config.frozenNow??this.mapNow,t=this.config.frozenNow??this.displayNow,i=this.resolveCenterLon(e),o=$e(e),{points:r,curvePoints:s}=this.terminatorGeometry(e,i),n=2*this.config.twilightDegrees*Fe/180,a=Math.max(.5,n/8),l=Math.max(4,.55*n),h=Math.max(1,n/5),c=this.config.imageryBase+function(e){const t=e.getUTCDate();let i,o=e.getUTCMonth()+1;return t<8?i="start":t<23?i="mid":(i="start",o=12===o?1:o+1),`blue-marble-${String(o).padStart(2,"0")}-${i}-2048.jpg`}(e),d=this.config.imageryBase+"black-marble-2048.jpg",p=(-i/360*Be%Be+Be)%Be;let u=0;if(this.config.showTimezoneRegions||this.config.showTimezoneBoundaries){const e=this.tzPolygonsCenterLon,t=null===e||Math.abs(e-i)>.5,o=t?i:e??i;this.tzData&&(t||null===this.tzPolygons)&&(this.tzPolygons=function(e,t,i,o=180){const r=[];for(const s of e.features){const e="Polygon"===s.geometry.type?[s.geometry.coordinates]:s.geometry.coordinates;let n="";for(const r of e)0!==r.length&&(n+=Ee(r[0],t,i,o));n&&r.push({offset:s.properties.zone,offsetLabel:He(s.properties.zone,s.properties.time_zone),name:s.properties.name??null,places:Ue(s.properties.places??""),d:n})}return r}(this.tzData,Be,Fe,o)),this.tzIanaData&&(t||null===this.tzIanaPolygons)&&(this.tzIanaPolygons=function(e){const t=e=>{let t=1/0,i=1/0,o=-1/0,r=-1/0;const s=/[ML]([\d.\-]+),([\d.\-]+)/g;let n;for(;n=s.exec(e);){const e=parseFloat(n[1]),s=parseFloat(n[2]);e<t&&(t=e),e>o&&(o=e),s<i&&(i=s),s>r&&(r=s)}return isFinite(t)?(o-t)*(r-i):0};return[...e].sort((e,i)=>t(i.d)-t(e.d))}(function(e,t,i,o=180){const r=[];for(const s of e.features){const e="Polygon"===s.geometry.type?[s.geometry.coordinates]:s.geometry.coordinates;let n="";for(const r of e)0!==r.length&&(n+=Ee(r[0],t,i,o));n&&r.push({tzid:s.properties.tzid,cityLabel:Le(s.properties.tzid),d:n})}return r}(this.tzIanaData,Be,Fe,o))),this.tzPolygonsCenterLon=o,u=(o-i)/360*Be}const m=this.resolveMainTimezone(),f=function(e,t){return e.toLocaleTimeString(void 0,{hour:"numeric",minute:"2-digit",second:"2-digit",timeZoneName:"short",...t?{timeZone:t}:{}})}(t,m),g=function(e){const t=String(e.getUTCHours()).padStart(2,"0"),i=String(e.getUTCMinutes()).padStart(2,"0"),o=String(e.getUTCSeconds()).padStart(2,"0");return`${t}:${i}:${o} UTC`}(t),v=function(e,t){return e.toLocaleDateString(void 0,{weekday:"short",month:"short",day:"numeric",year:"numeric",...t?{timeZone:t}:{}})}(t,m),y=this.resolveMarkers(),b=this.config.showTimezoneBand,$=b?-44:0,w=b?1068:Fe,k=`aspect-ratio: 2048 / ${w}; --geo-frame-ar: ${(Be/w).toFixed(6)}; --geo-day-brightness: ${this.config.dayBrightness}; --geo-night-contrast: ${this.config.nightContrast}; --geo-twilight-color: ${this.config.twilightColor}; --geo-twilight-opacity: ${this.config.twilightOpacity}; --geo-tz-line: ${this.config.timezoneLineColor};`;return V`
      <div class="frame" style="${k}">
        ...
        >
          ...
          <use href="#night-unit" x="${Be}" pointer-events="none"/>
          ...
          ${this.tzPolygons&&this.config.showTimezoneRegions?W`
                <g transform="translate(${u} 0)">
                  ...
                  <use href="#tz-offset-layer" x="${Be}" pointer-events="none"/>
                </g>
              `:""}
          ${this.tzIanaPolygons&&this.config.showTimezoneBoundaries?W`
                <g transform="translate(${u} 0)">
                  ...
                  <use href="#tz-iana-layer" x="${Be}" pointer-events="none"/>
                </g>
              `:""}

          ${b?W`
                <g id="hour-band">${Ce(e,Be,i)}</g>
                <use href="#hour-band" x="${-2048}" pointer-events="none"/>
                <use href="#hour-band" x="${Be}" pointer-events="none"/>
              `:""}
        </svg>
    ...
    `}getCardSize(){return 4}static async getConfigElement(){return await Promise.resolve().then(function(){return Ye}),document.createElement("geo-clock-card-editor")}static getStubConfig(){return{type:"custom:geo-clock-card",center:"sun"}}static{this.TOUCH_DISMISS_MS=2500}static{this.HOVER_IDLE_MS=3e4}clearDismissTimer(){void 0!==this.dismissTimer&&(clearTimeout(this.dismissTimer),this.dismissTimer=void 0)}clearIdleTimer(){void 0!==this.idleTimer&&(clearTimeout(this.idleTimer),this.idleTimer=void 0)}armIdleDismiss(){this.clearIdleTimer(),this.idleTimer=setTimeout(()=>{this.idleTimer=void 0,this.hoveredIana=null,this.hoveredOffset=null,this.hoveredMarker=null,this.hoverPos=null},Re.HOVER_IDLE_MS)}scheduleTouchDismiss(e){this.clearDismissTimer(),this.dismissTimer=setTimeout(()=>{this.dismissTimer=void 0,e()},Re.TOUCH_DISMISS_MS)}updateHoverPos(e){"touch"!==e.pointerType&&this.armIdleDismiss();const t=e.currentTarget.closest(".frame");if(!t)return;const i=t.getBoundingClientRect();this.hoverPosPending={x:e.clientX-i.left,y:e.clientY-i.top},this.hoverPosRaf||(this.hoverPosRaf=requestAnimationFrame(()=>{this.hoverPosRaf=0,this.hoverPosPending&&(this.hoverPos=this.hoverPosPending)}))}renderHomeMarkerOverlay(e,t,i,o){const r=this.resolveHomeLatLon();if(!r)return"";if(!this.config)return"";const{x:s,y:n}=ze(r.lat,r.lon,Be,Fe,t),a=s/Be*100,l=(n-i)/o*100,h=this.config.showHomeMarkerLabel,c=this.resolveHomeTimezone(),d=this.hass?.config?.location_name&&"string"==typeof this.hass.config.location_name?this.hass.config.location_name:"Home",p=c?Ze(e,c,this.config.markerShowDay):"";return V`
      <div
    ...
    `}resolveHomeTimezone(){const e=this.hass?.config?.time_zone;if("string"==typeof e&&e)return e;const t=this.resolveHomeLatLon();return t&&this.tzIanaData?this.lookupIanaTz(t.lat,t.lon)??void 0:void 0}renderMarkerOverlay(e,t,i,o,r,s){if(!this.config)return"";const n=this.config.markerLabelMode;return e.map(e=>{const{x:a,y:l}=ze(e.lat,e.lon,Be,Fe,i),h=a/Be*100,c=(l-o)/r*100,d=e.tzid?Ze(t,e.tzid,this.config.markerShowDay):"",p=this.hoveredMarker?.entity===e.entity,u=function(e,t,i){if(e||t)return i?e??t:t??e}(e.dayColor,e.nightColor,we(e.lat,e.lon,s))??e.color,m=u?`background: ${u};`:"";return V`
        <div
          class="marker${p?" is-active":""}"
          style="left: ${h}%; top: ${c}%;"
        >
