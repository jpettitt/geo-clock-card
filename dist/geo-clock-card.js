 ...
 */function fe(e){return me({...e,state:!0,attribute:!1})}const ge=Math.PI/180,ve=180/Math.PI,ye=Date.UTC(2e3,0,1,12,0,0),$e=e=>((e+180)%360+360)%360-180;function be(e){const t=(e.getTime()-ye)/864e5,i=280.46+.9856474*t,o=(357.528+.9856003*t)*ge,s=(i+1.915*Math.sin(o)+.02*Math.sin(2*o))*ge,r=(23.439-4e-7*t)*ge,n=Math.asin(Math.sin(r)*Math.sin(s))*ve,a=Math.atan2(Math.cos(r)*Math.sin(s),Math.cos(s))*ve,l=$e(i-a),h=e.getUTCHours()+e.getUTCMinutes()/60+e.getUTCSeconds()/3600+e.getUTCMilliseconds()/36e5;return{lat:n,lon:$e(-15*(h-12)-l)}}const we=Math.PI/180,ke=180/Math.PI,_e=1e-4;function xe(e,t={}){const i=t.stepDeg??1,o=(t.centerLon??180)-180;let s=e.lat;Math.abs(s)<_e&&(s=s>=0?_e:-1e-4);const r=Math.tan(s*we),n=[];for(let t=0;t<=360;t+=i){const i=(o+t-e.lon)*we,s=Math.atan(-Math.cos(i)/r)*ke;n.push([t,s])}return n}function ze(e,t,i,o,s=180){return{x:((t-(s-180))%360+360)%360/360*i,y:(90-e)/180*o}}function Te(e,t,i){const o=[];for(const[s,r]of e){const e=s/360*t,n=(90-r)/180*i;o.push(`${e.toFixed(2)},${n.toFixed(2)}`)}return o.join(" ")}const Ae=44;function Se(e,t,i=180){const o=function(e,t,i=180){const o=e.getUTCHours()+e.getUTCMinutes()/60+e.getUTCSeconds()/3600,s=t/24,r=i-180,n=[];for(let e=0;e<=24;e++){const t=r+15*e;let i=t/15;for(;i>12;)i-=24;for(;i<=-12;)i+=24;const a=Math.round(((o+t/15)%24+24)%24)%24;n.push({offset:i,realLon:t,centerX:e*s,hour12:(a+11)%12+1,isNoon:12===a,isMidnight:0===a})}return n}(e,t,i),s=t/24,r=[];for(let e=1;e<24;e++)r.push(e*s);return Z`
  ...
  `}let Ce=null,Me=null;function Ee(e,t,i,o=180){if(e.length<3)return"";const s=o-180,r=[];let n=null,a=1/0,l=-1/0;for(const[o,h]of e){let e=((o-s)%360+360)%360;if(null!==n){for(;e-n>180;)e-=360;for(;e-n<-180;)e+=360}n=e;const c=e/360*t,d=(90-h)/180*i;r.push([c,d]),c<a&&(a=c),c>l&&(l=c)}const h=r,c=e=>{let t="";for(let i=0;i<h.length;i++){const[o,s]=h[i];t+=`${0===i?"M":"L"}${(o+e).toFixed(1)},${s.toFixed(1)}`}return t+"Z"};let d=c(0);return l>t&&(d+=c(-t)),a<0&&(d+=c(t)),d}function Pe(e,t,i){let o=!1;for(let s=0,r=e.length-1;s<e.length;r=s++){const n=e[s][0],a=e[s][1],l=e[r][0],h=e[r][1];a>i!=h>i&&t<(l-n)*(i-a)/(h-a||Number.EPSILON)+n&&(o=!o)}return o}function Le(e){const t=e.split("/");return t.length<2?e:t[t.length-1].replace(/_/g," ")}const Ie=new Map;function De(e,t,i){const o=function(e,t){const i=`${e}|${Array.isArray(t)?t.join(","):""}`;let o=Ie.get(i);return o||(o={time:new Intl.DateTimeFormat(t,{timeZone:e,hour:"numeric",minute:"2-digit",second:"2-digit"}),date:new Intl.DateTimeFormat(t,{timeZone:e,weekday:"short",month:"short",day:"numeric"}),zoneName:new Intl.DateTimeFormat("en-US",{timeZone:e,hour:"numeric",timeZoneName:"long"}),offset:new Intl.DateTimeFormat("en-US",{timeZone:e,timeZoneName:"longOffset"})},Ie.set(i,o)),o}(t,i),s=(e,t)=>e.find(e=>e.type===t)?.value??"",r=o.zoneName.formatToParts(e),n=o.offset.formatToParts(e);return{time:o.time.format(e),date:o.date.format(e),name:s(r,"timeZoneName"),offset:s(n,"timeZoneName").replace(/^GMT/,"UTC")}}let Oe=null,He=null;function Ne(e,t){if(t&&/^UTC[+−\-]\d/.test(t))return t;const i=e>=0?"+":"-",o=Math.abs(e);return`UTC${i}${String(Math.trunc(o)).padStart(2,"0")}:${String(Math.round(60*(o-Math.trunc(o)))).padStart(2,"0")}`}function Ue(e){const t=e.trim();return t.length<=80?t:t.slice(0,77)+"…"}var Be;const Re=2048,Fe=1024;let je=class extends he{constructor(){super(...arguments),this.displayNow=new Date,this.mapNow=new Date,this.tzPolygons=null,this.tzIanaPolygons=null,this.tzPolygonsCenterLon=null,this.tzData=null,this.tzIanaData=null,this.ianaTzCache=new Map,this.hoveredIana=null,this.hoveredOffset=null,this.hoveredMarker=null,this.hoverPos=null,this.isCardVisible=!0,this.intersecting=!0,this.warnedFallback="",this.onIanaEnter=(e,t)=>{this.clearDismissTimer(),this.hoveredIana=t,this.updateHoverPos(e),"touch"===e.pointerType&&this.armTouchAutoDismiss()},this.onIanaLeave=e=>{"touch"!==e.pointerType?(this.hoveredIana=null,this.hoveredOffset||this.hoveredMarker||(this.hoverPos=null)):this.scheduleTouchDismiss(()=>{this.hoveredIana=null,this.hoveredOffset||this.hoveredMarker||(this.hoverPos=null)})},this.onOffsetEnter=(e,t)=>{this.clearDismissTimer(),this.hoveredOffset=t,this.updateHoverPos(e),"touch"===e.pointerType&&this.armTouchAutoDismiss()},this.onOffsetLeave=e=>{"touch"!==e.pointerType?(this.hoveredOffset=null,this.hoveredIana||this.hoveredMarker||(this.hoverPos=null)):this.scheduleTouchDismiss(()=>{this.hoveredOffset=null,this.hoveredIana||this.hoveredMarker||(this.hoverPos=null)})},this.onZoneMove=e=>{this.updateHoverPos(e)},this.onMarkerEnter=(e,t)=>{this.clearDismissTimer(),this.hoveredMarker=t,this.updateHoverPos(e),"touch"===e.pointerType&&this.armTouchAutoDismiss()},this.onMarkerLeave=e=>{"touch"!==e.pointerType?(this.hoveredMarker=null,this.hoveredIana||this.hoveredOffset||(this.hoverPos=null)):this.scheduleTouchDismiss(()=>{this.hoveredMarker=null,this.hoveredIana||this.hoveredOffset||(this.hoverPos=null)})}}static{Be=this}static{this.styles=n`
    :host {
      display: block;
      ...
      <div class="frame" style="${x}">
        ...
        >
          ...
          ${this.tzPolygons&&this.config.showTimezoneBoundaries?Z`
                ...
                <g transform="translate(${Re} 0)" pointer-events="none">
                  ${this.tzPolygons.map(e=>Z`<path class="tz-region" d="${e.d}"/>`)}
                </g>
              `:""}
